...
export default function MeasurementsPage() {
  const { measurements, setMeasurement, garmentDescription } = usePattern();
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <Badge variant="secondary">
            {garmentDescription ? "Editable" : "AI Estimated"}
          </Badge>
        </div>
        <p className="text-muted-foreground">
          {garmentDescription
            ? `Adjust measurements for your ${garmentDescription.summary.toLowerCase()}.`
            : "Measurements extracted from your photo. Review and adjust as needed before generating a pattern."
          }
        </p>
      </div>
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-24">
            <CardContent className="p-6 flex flex-col items-center">
              <h3 className="text-sm font-medium text-muted-foreground mb-4">Body Reference</h3>
              <svg
                viewBox="0 0 200 400"
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {UPPER_BODY_KEYS.map(renderMeasurementCard)}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {LOWER_BODY_KEYS.map(renderMeasurementCard)}
            </div>
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button size="lg" variant="outline" asChild>
              <Link to="/upload">Re-upload Photo</Link>
            </Button>
          </div>
        </div>
      </div>
